...
"""
    ...
    def analyze_case(self, case_description: str) -> Dict:
        ...
        # Reset case data with a new case ID
        self.case_data = {
            "metadata": {
                "case_id": self._generate_case_id(),
                "timestamp": datetime.datetime.now().isoformat(),
...
3. Address how this scenario explains any inconsistencies or anom
        # Step 4: Simulator runs different scenarios with probability estimates
        print("\n📊 The Simulator is modeling possible scenarios...")
        simulator_prompt = f"""As The Simulator, generate detailed scenarios that could explain all evidence:
...
"""
        ...
        # Extract scenarios and their probability estimates
        ...
        # Step 5: Hypothesis Generator creates competing explanations
...
"""
        ...
        # Extract hypotheses from structured data
        ...
        # Step 6: Evaluator tests hypotheses against evidence
...
"""
        ...
        for hypothesis in self.case_data["hypotheses"]["list"]:
            number = hypothesis["number"]
            eval_pattern = f"(?:HYPOTHESIS|Hypothesis)\s*{number}.*?(?:FINAL PROBABILITY|Final Probability|final probability):?\s*(\d+)%"
        ...
        # Step 7: Storyteller constructs the narrative
...
"""
        ...
        # Step 8: Desi Holmes provides the final solution
...
"""
    ...
    def format_final_solution(self, raw_solution):
        ...
        # If no sections were extracted, return the raw solution
        if len(sections) == 0:
            return raw_solution
    ...
    def save_case_to_file(self):
        ...
        # Create a filename with case ID and timestamp
    ...
    def add_follow_up_information(self, case_id: str, question_index: int, answer: str) -> Dict:
        ...
        # Check if case_id matches current case
        ...
        # Update Desi's analysis with the new information
...
"""
        ...
        # Extract updated confidence level
